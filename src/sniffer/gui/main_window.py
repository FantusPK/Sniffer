...
class MainWindow:
    ...
    def __init__(
        ...
        *,
        ...
        on_query_all: Callable[[], None] | None = None,
        ...
        self.config = ConfigPanel(
            ...
            scan_lo_var=scan_lo_var,
            scan_hi_var=scan_hi_var,
        ...
        self.controls = ControlBar(
            ...
            on_scan=on_scan or (lambda: None),
            on_query_all=on_query_all or (lambda: None),
